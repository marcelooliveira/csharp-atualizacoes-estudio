...
namespace csharp_6.V09
{
    //1. Com C#6 podemos remover a necessidade de mencionar os objetos
    //chamando seus métodos estáticos diretamente. Mas para isso
    //temos que usar using static
